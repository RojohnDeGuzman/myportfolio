...
const CERTIFICATIONS: { name: string; issuer: string; year?: string; url?: string }[] = [
  ...
  { name: 'System Administration and IT Infrastructure Services', issuer: 'Google (Coursera)', year: 'Mar 2026', url: 'https://www.coursera.org/account/accomplishments/verify/7CWVY40EBYOY' },
  { name: 'The Microsoft 365 Ecosystem', issuer: 'Microsoft (Coursera)', year: 'Mar 2026', url: 'https://www.coursera.org/account/accomplishments/verify/GNHU4WACW4W2' },
